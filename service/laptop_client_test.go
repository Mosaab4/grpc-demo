...
func startTestLaptopServer(t *testing.T, lapStore LaptopStore, imageStore ImageStore, ratingStore RatingStore) string {
	laptopServer := NewLaptopServer(lapStore, imageStore, ratingStore)
